...
def main(copy_num=copy_num):
    ...
    results_2 = Results()
    model_path = find_model_path(iter=1000, last=True, copy_num=10, model_type="dqn")
    ...
    temp = [[1], [0]]
    print(temp.count([1]))
    print(list(results_2.crit_obs)[:2])
    print(list(results_3.crit_obs)[:2])
    ...
    # plt.plot(episode_times_highway, label="Model 1", color="blue")
    # plt.plot(episode_times_merge, label="Model 2", color="red")
    # plt.plot(episode_times_merge2, label="Model 3", color="green")
